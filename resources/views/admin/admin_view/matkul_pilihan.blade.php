...
<h1>matakuliah pilihan <button type="button" data-toggle="modal" data-target="#addModal" class="icon_add"><i class="fas fa-plus-square fa-sm"></i></button></h1>
    ...
    <tr>
        ...
        <td>
            <button  data-toggle="modal" data-target="#editModal" class="icon_aksi1"
              data-mynama="{{$item->nama_matkul_pilihan}}" data-mykode="{{$item->kode_mk}}" data-mysks="{{$item->sks}}"  data-mysemester="{{$item->semester}}" data-id="{{$item->id}}" ><i class="fas fa-edit fa-3x"></i></button>
            <button onclick="window.location.href='/upload_matkul_pilihan/hapus_matkul_pilihan/{{ $item->id }}';" class="icon_aksi2" ><i class="fas fa-trash-alt fa-3x"></i></button>
        </td>
    </tr>
